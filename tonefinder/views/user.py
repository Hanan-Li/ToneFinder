"""tonefinder file for users."""

import flask
import tonefinder


# @tonefinder.app.route('/u/<user>/', methods=['GET', 'POST'])
# def user_page(user):
#     """User page."""
...
# @tonefinder.app.route('/u/<user>/followers/', methods=['GET', 'POST'])
...
# @tonefinder.app.route('/u/<user>/following/', methods=['GET', 'POST'])
